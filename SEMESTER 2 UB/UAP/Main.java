...
public class Main {
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            try {
                ...
                switch (pilihan) {
                    case 1:
                        tambahKendaraan(system, scanner);
                        break;
                    case 2:
                        system.tampilkanDaftarKendaraan();
                        break;
                    case 3:
                        sewaKendaraan(system, scanner);
                        break;
                    case 4:
                        kembalikanKendaraan(system, scanner);
                        break;
                    case 5:
                        running = false;
    ...
    private static void tambahKendaraan(GoDriveRentalSystem system, Scanner scanner) {
    ...
    private static void sewaKendaraan(GoDriveRentalSystem system, Scanner scanner) {
        ...
        try {
            ...
            // Cetak stack trace agar output mirip contoh (menampilkan exception + trace)
            e.printStackTrace();
        }
    }

    private static void kembalikanKendaraan(GoDriveRentalSystem system, Scanner scanner) {
